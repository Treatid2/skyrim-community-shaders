...
void TerrainBlending::SetupResources()
{
...

	{
		...
		DX::ThrowIfFailed(device->CreateShaderResourceView(
			REX::W32::AsReal(terrainDepth.texture), &srvDesc, REX::W32::AsReal(&terrainDepth.depthSRV)));
		...
		DX::ThrowIfFailed(device->CreateDepthStencilView(
			REX::W32::AsReal(terrainDepth.texture), &dsvDesc,
			REX::W32::CastTo<ID3D11DepthStencilView*>(&terrainDepth.views[0])));
...
void TerrainBlending::BlendPrepassDepths()
{
...

	{
		ID3D11ShaderResourceView* views[2] = {
			depthSRVBackup, REX::W32::AsReal(terrainDepth.depthSRV)
		};
...
void TerrainBlending::RenderTerrainBlendingPasses()
{
	...
	ID3D11ShaderResourceView* mainDepthSRV = mainDepthCopy ?
	                                             mainDepthCopy->srv.get() :
	                                             REX::W32::AsReal(terrainDepth.depthSRV);
